...
def write_input_file(inputfile, params):
    ...
    film_params = ("initial_film-height               10.0d0\n"
                   ...
                   "growth-limit_value                0.50d0\n")
    
    free_energy_params = ("mobility_coefficient_phi          1.0d0\n"
                          "free-energy_barrier_phi           1.0d0\n"
                          "gradient-energy_coefficient_phi   1.0d0\n"
                          "surface-localization_chi          0.2d0\n"
                          "surface_mobilities_chi            1.0d1 1.0d1\n"
                          "mobility_coefficients_chi         1.0d0 1.0d0\n"
    ...
    deposition_params  = ("vapor_diffusivity                 5.0d-3\n"
...
def submit_job_array(gen, inputfile, nruns):
    ...
    memphis_path = "/ascldap/users/saadesa/Softwares/MEMPHIS/memphis_modified/source/memphis.x" 
