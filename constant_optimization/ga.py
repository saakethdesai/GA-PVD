...
def initialize_deap(gen):
    ...
    #a1 = 0.05; b1 = 1.00 #upper and lower bound for comp_mean
    a2 = 0.10; b2 = 5.00 #upper and lower bound for M_phi 
    a3 = 5.00; b3 = 100.00 #upper and lower bound for M_surf_c
    a4 = 0.10; b4 = 5.00 #upper and lower bound for M_bulk_c
    a5 = 0.001; b5 = 0.100 #upper and lower bound for D
    a6 = 0.050; b6 = 1.50 #upper and lower bound for v
    
    bounds = [a2, b2, a3, b3, a4, b4, a5, b5, a6, b6]
...
def generate_individual(bounds, nparams):
    ...
    a2, b2, a3, b3, a4, b4, a5, b5, a6, b6 = bounds 
    ind = []
    #generate M_phi 
    M_phi = np.random.uniform(a2, b2)
    #generate M_surf_c 
    M_surf_c = np.random.uniform(a3, b3)
    #generate M_bulk_c 
    M_bulk_c = np.random.uniform(a4, b4)
    #generate D 
    D = np.random.uniform(a5, b5)
    #generate v 
    v = np.random.uniform(a6, b6)
    
    ind.extend([M_phi, M_surf_c, M_bulk_c, D, v])
...
def custom_mutation(individual, bounds, indpb):
    ...
    for i in range(len(individual)):
        if (random.random() < indpb):
            ...
            lower_end = max( 0.70*current_state, bounds[2*i] )
            upper_end = min( 1.30*current_state, bounds[2*i+1])
